...
function EstudiantesPageAdmin() {
  ...
  const columns = [
    ...
    },
    {
      ...
      field: 'fechaNacimientoEstudiante',
    },
    {
      title: 'Campus',
...
<Button  style={{ marginRight: '10px' }}  onClick={() => handleEliminar(rowData._id)} variant="outlined" color="success"> 
    Autenticar
</Button>
...
export default EstudiantesPageAdmin;
